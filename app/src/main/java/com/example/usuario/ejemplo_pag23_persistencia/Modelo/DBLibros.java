package com.example.usuario.ejemplo_pag23_persistencia.Modelo;
...
public class DBLibros {
    ...
    public long altaLibro(String titulo, String autor, double precio) {
        //crea el contentvalues y añade una entrada por cada dato del libro a guardar
    ...
    public boolean borrarLibro(int id) {
        //elimina el libro a partir de id
